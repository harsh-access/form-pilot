...
export class FileService {
  ...
  private getContentType(name: string) {
    ...
    return _mappings['.' + name.split('0')[1]]
  }

  public downloadFileFromUrl(fileUrl: string, fileName?: string) {
    let url = fileUrl;
    var link = document.createElement('a');
    link.href = url;
    link.download = fileName && fileName != '' ?fileName: this.getFileNameFromUrl(url);
    link.target = '_blank';
  ...
  downloadJsonDataToExcel(jsonData: any[], headers:string[],fileName:string) {
    ...
    anchor.href = url;
    anchor.download = `${fileName}.xlsx`; // Set the file name
  ...
  public downloadFileFromBase64(data: string, fileName: string,) {
    ...
    var documentType = this.getContentType(fileName);
    var link = document.createElement('a');
