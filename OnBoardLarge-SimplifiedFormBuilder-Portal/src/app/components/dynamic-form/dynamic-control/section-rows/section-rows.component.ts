...
export class SectionRowsComponent implements OnInit {
  ...
  private generalPreparationMethod() {
    ...
    const allowedControlTypes = ['TextBox', 'DatePicker', 'RadioButton', 'MultilineTextbox', 'DropDown', 'SingleFileUpload', 'Lable', 'MultipleSelectCheckBox', 'SwitchCheckBox', 'LableCheckBox'];
