...
export class FieldControlComponent implements OnInit {
  ...
  constructor(private dynamicFormService: DynamicFormService, private fileService: FileService) {
  }
  ...
  valueChangeForDependent(field: Columns) {
  ...
  getFileUploadClass(field: Columns) {
  ...
  getConditionalCSSFlag(field: Columns) {
    let flag = '';
