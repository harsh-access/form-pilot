    ...
    case 6: // Declarations
      return [
        ...
        },
        {
          ...
          attr: {
            userGuideTxt:
              'Upload a Word or PDF document containing a signature merge tag (if applicable) for the user to view and sign. Please contact your Admin for the list of available merge tags that can be used in your document.',
