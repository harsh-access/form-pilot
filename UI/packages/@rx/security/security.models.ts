...
export class userExternalPermissions {
  constructor(userPermission?: userExternalPermissions) {
    if (userPermission) {
      this.permissionName = userPermission.permissionName;
      this.permissionTypeId = userPermission.permissionTypeId;
...
export class User {
  ...
  userExternalPermissions: userExternalPermissions[];
