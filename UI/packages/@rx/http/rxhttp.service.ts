...
export class RxHttp {
    ...
    private makeGetRequest<T>(url: string | AuthorizeApi, moduleId?: AuthorizeApi, showSpinner: boolean = true): Observable<T> {
        ...
        if (options.options)
            return this.http.get(options.uri, options.options)
                .pipe(
                    catchError(error => this.handleError(error, 'GET', null)),
    ...
    search<T>(url: string | AuthorizeApi, jObject: Object, showToast?: boolean): Observable<T> {
        ...
        if (options.options)
            return this.http.post(
                ...
                catchError(error => this.handleError(error, 'POST', showToast)),
                map((response: Response) => {
    ...
    put<T>(url: string | AuthorizeApi, jObject: Object, mainRecordId?: any, showToast?: boolean): Observable<T> {
        ...
        if (authorizeApi.api) {
            if (authorizeApi.keys) {
                ...
                if (mainRecordId)
                    authorizeApi.mainRecordId = mainRecordId;
                else
        ...
        if (options.options) {
            ...
            return this.http.put(
                ...
                catchError(error => this.handleError(error, 'PUT', showToast)),
                map((response: Response) => {
    ...
    patch<T>(url: string | AuthorizeApi, id: any, jObject: Object, showToast?: boolean): Observable<T> {
        ...
        if (options.options)
            return this.http.patch(
                ...
                catchError(error => this.handleError(error, 'PATCH', showToast)),
                map((response: Response) => {
    ...
    delete<T>(url: string | AuthorizeApi, id: any, parentId?: any, showToast?: boolean): Observable<T> {
        ...
        if (options.options)
            return this.http.delete(
                ...
                catchError(error => this.handleError(error, 'DELETE', showToast)),
                map((response: Response) => {
